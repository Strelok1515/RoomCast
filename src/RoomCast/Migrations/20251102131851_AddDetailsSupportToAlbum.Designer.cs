...
namespace RoomCast.Migrations
{
    ...
    [Migration("20251102131851_AddDetailsSupportToAlbum")]
    partial class AddDetailsSupportToAlbum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RoomCast.Models.Casting.ScreenMediaAssignment", b =>
                {
                    ...
                    b.ToTable("ScreenMediaAssignments");
                });
            ...
            modelBuilder.Entity("RoomCast.Models.Casting.ScreenMediaAssignment", b =>
                {
                    ...
                    b.HasOne("RoomCast.Models.Casting.Screen", "Screen")
                        .WithMany("ScreenMediaAssignments")
                        .HasForeignKey("ScreenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
